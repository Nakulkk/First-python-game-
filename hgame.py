...
bgm = pygame.mixer.music.load("pics\\theme.wav.mp3")
...
class player():
	def __init__(self,x,y,width,height):
		...
		self.height = height
		self.speed = 5
		self.isjump = False#jump karne ke leya
		self.jumpheight = 10
		self.left = False
		self.right = False
		self.walkCount= 0
...
while run:
	...
	Clock.tick(25)#ye hai frame rate deside karne ke liye charactter ka
...
#which key to press to for jump run and throw the shrukin
